...
public final class InputClassDirectory {
    ...
    public static InputClassDirectory directoryWithClasses(Path baseDirectory, Class<?>... classes) throws IOException, ClassNotFoundException {
    ...
    private static void copyResourceToFile(ClassLoader classLoader, String resource, Path basePath) throws IOException, ClassNotFoundException {
