...
public class NestedBenchmarkSuiteBuilderTest {
    ...
    private static final AstResourceLoader astLoader = new AstResourceLoader(NestedBenchmarkSuiteBuilderTest.class);
    ...
    private static CompilationUnit originalAst(Class<?> clazz, InputClassDirectory directory) throws IOException {
        ...
        Path file = directory.sourcesDirectory().resolve(enclosingClassName.replace('.', File.separatorChar) + ".java");
    ...
    public void canConvertSimpleUnitTest() throws ClassNotFoundException, IOException {
        ...
        expected.put(SimpleUnitTest.class.getName(), astLoader.load("SimpleUnitTest_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(SimpleUnitTest.class.getName()).buildSuite();
    ...
    public void includesAllTestCases() throws IOException, ClassNotFoundException {
        ...
        Map<String, CompilationUnit> expected = new HashMap<>();
        expected.put(TwoTestCases.class.getName(), astLoader.load("TwoTestCases_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(TwoTestCases.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    @Test
    public void canConvertUnitTestWithFixtureMethodsAndRules() throws ClassNotFoundException, IOException {
        inputClassDirectory.add(UnitTestWithFixtureMethodsAndRules.class);
        Map<String, CompilationUnit> expected = new HashMap<>();
        expected.put(UnitTestWithFixtureMethodsAndRules.class.getName(), astLoader.load("UnitTestWithFixtureMethodsAndRules_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(UnitTestWithFixtureMethodsAndRules.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    public void includesPresentSuperclass() throws IOException, ClassNotFoundException {
        ...
        expected.put(TestAbstractClass.class.getName(), astLoader.load("TestAbstractClass_Expected.java"));
        expected.put(TestImplementation.class.getName(), astLoader.load("TestImplementation_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(TestImplementation.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    public void excludesAbsentSuperclass() throws IOException, ClassNotFoundException {
        inputClassDirectory.add(TestImplementation.class);
        Map<String, CompilationUnit> expected = new HashMap<>();
        expected.put(TestImplementation.class.getName(), astLoader.load("TestImplementation_Expected_NoSuperclass.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(TestImplementation.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
    ...
    public void includesAllPresentSuperclasses() throws IOException, ClassNotFoundException {
        ...
        expected.put(TestInterface.class.getName(), originalAst(TestInterface.class));
        expected.put(TestAbstractClass.class.getName(), astLoader.load("TestAbstractClass_Expected.java"));
        expected.put(TestImplementation.class.getName(), astLoader.load("TestImplementation_Expected_Abstract.java"));
        expected.put(TestImplementationSubclass.class.getName(), astLoader.load("TestImplementationSubclass_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(TestImplementationSubclass.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    public void addingWithNestedIncludesNestedTests() throws IOException, ClassNotFoundException {
        ...
        Map<String, CompilationUnit> expected = new HashMap<>();
        expected.put(ClassWithNestedTests.class.getName(), astLoader.load("ClassWithNestedTests_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClassIncludingNested(ClassWithNestedTests.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    @Test
    public void addingWithoutNestedExcludesNestedTests() throws IOException, ClassNotFoundException {
        inputClassDirectory.add(ClassWithNestedTests.class);
        inputClassDirectory.add(ClassWithNestedTests.Nested.class);
        inputClassDirectory.add(ClassWithNestedTests.Nested.NestedNested.class);
        Map<String, CompilationUnit> expected = new HashMap<>();
        ...
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(ClassWithNestedTests.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    public void canHandleInheritanceOfNestedTests() throws IOException, ClassNotFoundException {
        ...
        inputClassDirectory.add(ClassWithNestedTestSubclasses.NestedSubclass.NestedNestedSubclass.class);
        Map<String, CompilationUnit> expected = new HashMap<>();
        expected.put(ClassWithNestedTests.class.getName(), astLoader.load("ClassWithNestedTests_Expected_Abstract.java"));
        expected.put(ClassWithNestedTestSubclasses.class.getName(), astLoader.load("ClassWithNestedTestSubclasses_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClassIncludingNested(ClassWithNestedTestSubclasses.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    public void canHandleNamingConflicts() throws IOException, ClassNotFoundException {
        ...
        inputClassDirectory.add(TestWithNestedTypesNamedBenchmark._Benchmark.Nested._Benchmark_0.class);
        inputClassDirectory.add(TestWithNestedTypesNamedBenchmark._Benchmark.Nested.NestedNested.class);
        Map<String, CompilationUnit> expected = new HashMap<>();
        expected.put(TestWithNestedTypesNamedBenchmark.class.getName(), astLoader.load("TestWithNestedTypesNamedBenchmark_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClassIncludingNested(TestWithNestedTypesNamedBenchmark.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    public void doesNotModifyNonTests() throws IOException, ClassNotFoundException {
        ...
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(SimpleClass.class.getName()).addTestClass(SimpleSuperclass.class.getName()).addTestClass(SimpleSubclass.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    @Test
    public void includesButDoesNotCreateBenchmarkForNonAddedTest() throws IOException, ClassNotFoundException {
        inputClassDirectory.add(SimpleUnitTest.class);
        Map<String, CompilationUnit> expected = new HashMap<>();
    ...
    public void doesNotCreateBenchmarkForInterface() throws IOException, ClassNotFoundException {
        ...
        expected.put(TestInterface.class.getName(), originalAst(TestInterface.class));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(TestInterface.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    public void canHandleExpectedExceptions() throws IOException, ClassNotFoundException {
        ...
        Map<String, CompilationUnit> expected = new HashMap<>();
        expected.put(ExceptionTest.class.getName(), astLoader.load("ExceptionTest_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(ExceptionTest.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    @Test
    public void createsBenchmarkForClassWithOnlyInheritedTestMembers() throws IOException, ClassNotFoundException {
        inputClassDirectory.add(TestAbstractClass.class);
        inputClassDirectory.add(TestSubclassWithoutOwnTests.class);
        Map<String, CompilationUnit> expected = new HashMap<>();
        expected.put(TestAbstractClass.class.getName(), astLoader.load("TestAbstractClass_Expected.java"));
        expected.put(TestSubclassWithoutOwnTests.class.getName(), astLoader.load("TestSubclassWithoutOwnTests_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(TestSubclassWithoutOwnTests.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    @Test
    public void createsBenchmarkForClassWithOnlyFixtureMethods() throws IOException, ClassNotFoundException {
        inputClassDirectory.add(ClassWithOnlyFixtureMethods.class);
        Map<String, CompilationUnit> expected = new HashMap<>();
        expected.put(ClassWithOnlyFixtureMethods.class.getName(), astLoader.load("ClassWithOnlyFixtureMethods_Expected.java"));
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory());
        Map<String, CompilationUnit> suite = builder.addTestClass(ClassWithOnlyFixtureMethods.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
        }
    ...
    @Test
    public void includesClassesFromSeparateDirectories(@TempDir Path tempDir) throws IOException, ClassNotFoundException {
        ...
        expected.put(TestAbstractClass.class.getName(), astLoader.load("TestAbstractClass_Expected.java"));
        expected.put(TestImplementation.class.getName(), astLoader.load("TestImplementation_Expected.java"));
        List<Path> sourcePaths = List.of(dir1.sourcesDirectory(), dir2.sourcesDirectory(), dir3.sourcesDirectory());
        List<Path> classPath = List.of(dir4.bytecodeDirectory(), dir5.bytecodeDirectory(), dir6.bytecodeDirectory());
        NestedBenchmarkSuiteBuilder builder = new NestedBenchmarkSuiteBuilder(sourcePaths, classPath);
        Map<String, CompilationUnit> suite = builder.addTestClass(TestImplementation.class.getName()).buildSuite();
        assertEquals(expected.keySet(), suite.keySet());
        for (String compilationUnit : expected.keySet()) {
            assertThat(suite.get(compilationUnit), equalsAst(expected.get(compilationUnit)));
