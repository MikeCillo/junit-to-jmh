...
public class UnitTestClassRepositoryTest {
    ...
    @BeforeEach
    public void setUpRepository(@TempDir Path tempDir) throws IOException, ClassNotFoundException {
        inputClassDirectory = InputClassDirectory.directoryWithClasses(tempDir);
        repository = new UnitTestClassRepository(new InputClassRepository(inputClassDirectory.sourcesDirectory(), inputClassDirectory.bytecodeDirectory()));
    }
    ...
    public void parsesSimpleUnitTest() throws IOException, ClassNotFoundException {
        ...
        UnitTestClass expected = UnitTestClass.Builder.forClass(testClass.getCanonicalName()).withTest("test").build();
    ...
    public void parsesExceptionTest() throws IOException, ClassNotFoundException {
        ...
        inputClassDirectory.add(testClass);
        UnitTestClass expected = UnitTestClass.Builder.forClass(testClass.getCanonicalName()).withExceptionTest("testException", Exception.class.getCanonicalName()).build();
        UnitTestClass actual = repository.findClass(testClass.getCanonicalName());
        assertEquals(expected, actual);
    }
    ...
    public void parsesFixtureMethodsAndRules() throws IOException, ClassNotFoundException {
        ...
        inputClassDirectory.add(testClass);
        UnitTestClass expected = UnitTestClass.Builder.forClass(testClass.getCanonicalName()).withBeforeClass("beforeClass1").withBeforeClass("beforeClass2").withAfterClass("afterClass1").withAfterClass("afterClass2").withClassRuleField("classRuleField1").withClassRuleField("classRuleField2").withClassRuleMethod("classRuleMethod1").withClassRuleMethod("classRuleMethod2").withBefore("before1").withBefore("before2").withAfter("after1").withAfter("after2").withInstanceRuleField("ruleField1").withInstanceRuleField("ruleField2").withInstanceRuleMethod("ruleMethod1").withInstanceRuleMethod("ruleMethod2").withTest("test").build();
        UnitTestClass actual = repository.findClass(testClass.getCanonicalName());
        assertEquals(expected, actual);
    }
    ...
    public void parsesSuperclass() throws IOException, ClassNotFoundException {
        ...
        inputClassDirectory.add(testClass);
        UnitTestClass expectedSuperSuper = UnitTestClass.Builder.forClass(testSuperSuperclass.getCanonicalName()).withTest("abstractClassTest").build();
        UnitTestClass expectedSuper = UnitTestClass.Builder.forClass(testSuperclass.getCanonicalName()).withSuperclass(expectedSuperSuper).withTest("implementationTest").build();
        UnitTestClass expected = UnitTestClass.Builder.forClass(testClass.getCanonicalName()).withSuperclass(expectedSuper).withTest("subclassTest").build();
        UnitTestClass actual = repository.findClass(testClass.getCanonicalName());
        assertEquals(expected, actual);
    }
    ...
    public void handlesMissingSuperclass() throws IOException, ClassNotFoundException {
        ...
        Class<?> testClass = TestImplementationSubclass.class;
        inputClassDirectory.add(testClass);
        UnitTestClass expectedSuper = UnitTestClass.Builder.forClass(testSuperclass.getCanonicalName()).build();
        UnitTestClass expected = UnitTestClass.Builder.forClass(testClass.getCanonicalName()).withSuperclass(expectedSuper).withTest("subclassTest").build();
        UnitTestClass actual = repository.findClass(testClass.getCanonicalName());
        assertEquals(expected, actual);
    }
    ...
    public void skipsIgnoredUnitTest() throws IOException, ClassNotFoundException {
        ...
        inputClassDirectory.add(testClass);
        UnitTestClass expected = UnitTestClass.Builder.forClass(testClass.getCanonicalName()).build();
        UnitTestClass actual = repository.findClass(testClass.getCanonicalName());
        assertEquals(expected, actual);
    }
